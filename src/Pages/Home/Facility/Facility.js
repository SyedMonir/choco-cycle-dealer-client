...
const Facility = () => {
  return (
    <section className="text-center py-12 text-gray-300 bg-[#1f4037]">
      ...
      <span class="inline-block h-1 w-16 rounded bg-[#88f5c2] mt-6 mb-4"></span>
          ...
          <div class="flex flex-wrap -m-4">
            <div class="lg:w-1/3 lg:mb-0 mb-6 p-4">
              <div class="h-full text-center">
                <img
                  alt="testimonial"
                  class="w-24 h-24 mb-8 p-2 object-cover object-center rounded-full inline-block border-2 border-gray-800 bg-gray-800 bg-opacity-10"
                ...
                <span class="inline-block h-1 w-10 rounded bg-[#88f5c2] mt-6 mb-4"></span>
